  ...
  <section id="pricing">
    <div class="container">
      <div class="title-block">
        <h2>Precios y variedades</h2>
        <p>Nunca antes te llegaron tan rápido.</p>
      </div>
      <div class="row">
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">EMPANADAS</h3>
            <img src="https://assets.kraftfoods.com/recipe_images/opendeploy/90534_640x428.jpg" style="width:100%" alt="">
            <h6>CARNE</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('carne'); ?> empanadas</p>
            <div class="divider-light"></div>
            <ul>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Carne Vacuna</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Cebolla</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Comino</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Fritas</li>
          </ul>
            <div class="text-center">
              <a href="#" class="btn btn-demo">Ordenar</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">EMPANADAS</h3>
            <img src="https://cocinacentral.net/wp-content/uploads/2015/10/empanadas-choclo-.jpg" style="width:100%;" alt="">
            <h6>CHOCLO</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('choclo'); ?> empanadas</p>
            <div class="divider-light"></div>
            <ul>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Carne Vacuna</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Cebolla</li>
        ...
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">EMPANADAS</h3>
            <img src="https://holavegan.theblogpress.com/files/2014/11/empanadas-arabes.jpg" style="width:100%" alt="">
            <h6>ARABES</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('arabes'); ?> empanadas</p>
            <div class="divider-light"></div>
            <ul>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Carne Vacuna</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Cebolla</li>
...
<button type="button" onclick='esconde()'  style="color:white;background-color:#007bff" name="button">Chatear!</button>
    ...
    width="270"
    height="330"
    src="https://console.dialogflow.com/api-client/demo/embedded/527cd2fa-57a0-4d66-a899-03fb98132f30">
</iframe></div>
